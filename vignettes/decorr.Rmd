...
```{r igraph.1, warning=FALSE, fig.align="center", out.width="75%"}
par(mfrow=c(1, 2))
...
```{r clust.comp, warning=FALSE, fig.align="center", out.width="75%"}
par(mfrow=c(1, 2))
...
```{r hclust.compar, warning=FALSE, fig.align="center", out.width="75%"}
