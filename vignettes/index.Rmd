...
img.filename <- plot_dec_grph(nds.df, eds.df, imgs,
                              site, decor, dataDir,
...
At times some nodes are non-contemporaneous with one another, like on the Ibahernando stelae. This stelae was reused as a funerary stelae during Roman times with the addition of a Latin inscription "*Alloquiu protaeidi.f hece. stitus*": Alluquio, son of Protacido, lies here [@Almagro66b]. The writing (`ecriture`, node 1) has been carved over a spear (`lance`, node 2) and overlaps partially a V-notched shield (`bouclier`, node 3). The edges between node 1 and node 2, and the edge between node 1 and node 3, are *diachronic* edges  
...
l_dec_df <- contemp_nds(nds.df, eds.df, selected.nd)
img.filename <- plot_dec_grph(l_dec_df$nodes, l_dec_df$edges, imgs,
