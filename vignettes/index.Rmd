...
ibahernando.path <- paste0(getwd(),"/docs/img/ibahernando.png")
brozas.path <- paste0(getwd(),"/docs/img/brozas.png")
```
&nbsp;
...
```{r gis, out.width="60%", echo=F, fig.align='center', fig.cap="GIS view of the Cerro Muriano 1 stelae with the Voronoi cells of its GUs, GUs (main nodes) and proximity links between these GUs (edges)"}
...
```{r img.graph.zarza, out.width="60%", fig.align="center", warning=FALSE, fig.cap="Zarza de Montsanchez stelae (decoration 4)"}
