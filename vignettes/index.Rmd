...
![Detail of the Solana de Cabanas stelae (Caceres, Spain) dated to the Late Bronze Age](`r solanas.path`){width=220px}
...
![GIS view. The Solana de Cabanas stelae: from its photograph to the modeling of its graphical content](`r solanas.vor.path`){width=900px}
