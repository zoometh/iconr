...
<<echo=FALSE, message=FALSE, warning=FALSE, fig=TRUE, fig.pos = 'H', fig.width=10, fig.height=3, fig.cap="\\label{fig:figs}concatenate of graphical units (GUs) is art">>=
...
<<echo=FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.pos = 'H', fig.width=2, fig.height=2, fig.cap="\\label{fig:figs}Potential spatial relations between GUs.">>=
# library(extrafont)
# loadfonts(device = "win")
par(mar=c(0.1,0.1,0.1,0.1) )
ugs <- data.frame(name=c("a","r","t"))
