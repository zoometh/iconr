...
\usepackage{Sweave}
\begin{document}
\input{article_rvTH11-concordance}
...
\begin{figure}[H]
\centering
\includegraphics{corpus}
\caption{\label{fig:corpus} Dataset of four stelae showing the information on the decoration (\code{site}, \code{decor} and \code{img}) and the dimensions in pixel of the decoration image}
\end{figure}


\subsection{Functions} \label{sec:functions}

The first step is to load \code{nodes}, \code{edges} and \code{images} dataframes
...
\end{Sinput}
\end{Schunk}
\includegraphics{article_rvTH11-read_df}
...
\end{Sinput}
\end{Schunk}
\includegraphics{article_rvTH11-f.lgrph}
