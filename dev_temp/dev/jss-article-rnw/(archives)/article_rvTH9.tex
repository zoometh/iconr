...
\usepackage{Sweave}
\begin{document}
\input{article_rvTH9-concordance}
...
\centering
\includegraphics{article_rvTH9-art_only}
...
\begin{minipage}{0.8\textwidth}
\centering
\includegraphics{article_rvTH9-art_or_rat}
