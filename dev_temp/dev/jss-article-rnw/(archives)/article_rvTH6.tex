...
\usepackage{Sweave}
\begin{document}
\input{article_rvTH6-concordance}
...
In this article we present the \proglang{R} package \pkg{decorr}. Its purpose is to offer explicit concepts, methods and indexes to analyse a graphical content in order to make possible cross-cultural comparisons. The package \pkg{decorr} uses the package \pkg{magick} for image manipulation \citep{Ooms18}, \pkg{igraph} \citep{Csardi06} for graph and network analysis
