...
<<echo=TRUE, message=FALSE, warning=FALSE, fig=TRUE, fig.pos = 'H', fig.align="center", fig.width=3, fig.cap="\\label{fig:figs}Torrejon Rubio 1 decoration">>=
library("decorr")
par(mar=c(0,0,0,0))
sit <- "Torrejon Rubio" ; dec <- "Torrejon Rubio 1"
nds.df <- read_nds(site = sit, decor = dec, dev = ".tsv",
...
<<echo=TRUE, message=FALSE, warning=FALSE, fig=TRUE, fig.pos = 'H', fig.align="center", fig.height=8, fig.cap="\\label{fig:figs}comparisons between 1 (Cerro Muriano 1) and 4 (Zarza de Montsanchez) decorations">>=
par(mar=c(0,0,0,0))
