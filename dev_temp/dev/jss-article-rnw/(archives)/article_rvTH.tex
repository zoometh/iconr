...
\author{Thomas Huet\\Universite Paul-Valery}
...
%  instructions are marked by vertical bars.
  Pre- and Protohistorical iconography, is characterised by the absence of a writing system.
  Signs are displayed mostlty a discontinuous figures which can have different relationships one with another.
  To understand meaningful associations of signs, geometric tools, graph analysis and dataset ...
  by \cite{Huet:18}, in \proglang{R}.
}
...
Iconography from Prehistory and Protohistorical times (here, from ca. 10,000 BC to 500 BC) has been the study...
...
\subsection{Function \code{list_dec()}} \label{sec:funct_list_dec}

This function store graphs in a list.

\subsection{Function \code{...}} \label{sec:funct_etc..}
