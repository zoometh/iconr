...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'igraph' was built under R version 3.6.3}}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:base':\\\#\# \\\#\#\ \ \ \  union}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'extrafont' was built under R version 3.6.2}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Registering fonts with R}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in text.default(x, y, labels = labels, col = label.color, family = label.family, : font width unknown for character 0x61}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in text.default(x, y, labels = labels, col = label.color, family = label.family, : font metrics unknown for character 0x4d}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in text.default(x, y, labels = labels, col = label.color, family = label.family, : font width unknown for character 0x72}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in text.default(x, y, labels = labels, col = label.color, family = label.family, : font width unknown for character 0x74}}\end{kframe}
