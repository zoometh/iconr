...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in graph\_from\_literal(a - +r, r - +t): could not find function "{}graph\_from\_literal"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(g, layout = cbind(seq(-1, 1, length.out = gorder(g)), 0), : object 'g' not found}}\end{kframe}
